...
IS_PRODUCTION=0
# JWT FRONTEND EXPIRATION (HOURS) - STORAGE TIME FOR THIS TOKEN IN DOM
JWT_FRONTEND_EXPIRATION=
# JWT BACKEND EXPIRATION (MINUTES) - LIMIT BEFORE EXPIRING.
JWT_BACKEND_EXPIRATION=
```
